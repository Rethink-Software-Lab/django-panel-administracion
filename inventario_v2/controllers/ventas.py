...
from inventario.models import ProductoInfo, Ventas, User, AreaVenta, Producto
from ..schema import AddVentaSchema
        ...
        if producto_info.categoria.nombre == "Zapatos":
            ...
            try:
                ...
                with transaction.atomic():
                    ...
                    productos = Producto.objects.filter(area_venta=area_venta, venta__isnull=True, info=producto_info)[:cantidad]
